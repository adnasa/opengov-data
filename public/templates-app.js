angular.module('templates-app', ['about/about.tpl.html', 'home/home.tpl.html', 'people/people.tpl.html']);
...
angular.module("people/people.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("people/people.tpl.html",
    "<div class=\"row\">\n" +
    "  <h1 class=\"page-header\">The Elevator Pitch<small>For the lazy and impatient.</small></h1>\n" +
    "\n" +
    "\n" +
    "\n" +
    "</div>\n" +
